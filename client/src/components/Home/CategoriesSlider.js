...
import { faMoneyBillWheat, 
        faChild, faPersonCane, 
        faCommentDollar, faWheelchair,
        faSyringe, faMountainSun, faTree, faSchool, faHouse, faBridge, faOtter, faPlaneDeparture, faDna, faTableTennisPaddleBall
                        ...
                        <div className="icon-bx-wraper text-center style-1 m-b30 wow fadeInUp" data-wow-delay="0.2s">
                            <div className="icon-lg m-sm-b20 m-b30"> 
                                <Link to={"/project-categories"} className="icon-cell">
                                    <FontAwesomeIcon className='icon_shake' icon={d.icon}></FontAwesomeIcon>
                                </Link>
                            </div>
